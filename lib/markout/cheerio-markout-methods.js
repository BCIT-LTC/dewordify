module.exports = function($,paged) {
	...
	$.prototype.getMarkoutPropertyValue = function () {
		...
		array.shift();
		if(this.length > 1) {
			console.log(chalk.bgYellow("[MARKOUT ERROR] Duplicate markout properties provided"));
			console.log(chalk.bgYellow("	", paged ? "See: " + $("h1").text() : ""));
			console.log(chalk.bgYellow("	 Output: ", text));
		}
